...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2017 at 04:32 AM
...
INSERT INTO `tb_diagnosa` (`id_aturan`, `id_gejala`) VALUES
(1, 'G000002'),
(2, 'G000003'),
(3, 'G000007'),
(4, 'G000019'),
...
--
ALTER TABLE `tb_diagnosa`
MODIFY `id_aturan` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
