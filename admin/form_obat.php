...
if(isset($_POST['add_baru'])){
		...
		$sql_s="update tb_penyakit set obat='".$keterangan."' where id_penyakit='".$_GET['id']."'";
...
<body>
<p><strong style="font-size: 20px"> Tambah Data Obat Penyakit  <?php echo _tampil_nama_penyakit($_GET['id']);?></strong>
			<hr>
			</p>
			<br>
