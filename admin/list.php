...
if(isset($_GET['list'])){
	...
	if($_GET['list']!="lap_penyakit" and $_GET['list']!="member" and $_GET['list']!="lap_gejala" and $_GET['list']!="pesan" and $_GET['list']!="rule") {
	...
	}elseif($_GET['list']=="penyakit" or $_GET['list']=="lap_penyakit"){
		$param="P";
		$sql_page="select * from tb_penyakit";	
...
//ambil data berdasarkan pilihan menu
        ...
        while($data=mysql_fetch_object($result)){
        	...
        	echo '</table>';
	//penyakit
		}elseif($_GET['list']=="penyakit"){
			$param="P";
			$sql = "SELECT * FROM tb_penyakit ORDER BY `id_penyakit` Asc LIMIT $offset,$limit";
        ...
        while($data=mysql_fetch_object($result)){
            ...
            echo '<tr>
                ...
                <td><a href="form_ubah.php?list='.$_GET['list'].'&id='.$data->id_penyakit.'">Ubah</a>
				<td><a href="form_gejala.php?list='.$_GET['list'].'&id='.$data->id_penyakit.'">Gejala</a></td>
				<td><a href="form_solusi.php?list='.$_GET['list'].'&id='.$data->id_penyakit.'">Solusi</a></td>
				<td><a href="form_obat.php?list='.$_GET['list'].'&id='.$data->id_penyakit.'">Obat</a></td>
				<td><a href="form_kategori.php?list='.$_GET['list'].'&id='.$data->id_penyakit.'">Kategori</a></td>
                <td><a href="hapus.php?tabel=tb_penyakit&field=id_penyakit&list=penyakit&id='.$data->id_penyakit.'" onclick="delete_confirm2(\''.$data->id_penyakit.'\')">Hapus</a></tr>';
        }
        	echo '</tbody>';
        	echo '</table>';
        ...
        while($data=mysql_fetch_object($result)){
            ...
            echo '<tr>
				...
				<td>'._tampil_nama_penyakit($data->id_penyakit).'</td>
				</tr>';
        }
        	echo '</tbody>';
        	echo '</table>';
...
?>
 <?php
 if(($_GET['list']!="lap_penyakit")and($_GET['list']!="lap_gejala")){
