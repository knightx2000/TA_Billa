...
$kategori="";
if(isset($_GET['id'])){
	$sql="select * from tb_penyakit where id_penyakit='".$_GET['id']."'";
...
if(isset($_POST['add_baru'])){
		...
		$sql_s="update tb_penyakit set kategori='".$keterangan."' where id_penyakit='".$_GET['id']."'";
...
<body>
<p><strong style="font-size: 20px"> Tambah Data Kategori Penyakit  <?php echo _tampil_nama_penyakit($_GET['id']);?></strong>
			<hr>
			</p>
			<br>
