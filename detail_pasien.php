...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.3.0.60745 -->
    ...
    {
      if (form.nama.value == "") {
        alert( "Maaf, Nama anda tidak boleh dikosongkan.!!" );
...
<h1 class="art-headline">
    <a href="/">Sistem Pakar Penyakit Hipertensi</a>
</h1>
...
<div class="art-sheet clearfix">
			...
			<h2>Profile Pasien</h2><hr/>		
			
			<label>Nama pasien :</label>
			<input id="nama" name="nama" placeholder="Nama Pasien" type="text">
            ...
            <input type='submit' class='btn btn-primary btn-block btn-large' value='Next ' >
		  </form>
