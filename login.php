...
<div class="art-sheet clearfix">
                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <h2 class="art-postheader">Implementasi Sistem Pakar untuk Diagnosis Penyakit Hipertensi dengan Metode Certainty Factor dan Forward Chaining Berbasis Web</h2>
   ...
   <div id="kanan">
	      ...
	      <form action="daftar_action.php" method="post">
			...
			<input id="nama_lengkap" name="nama_lengkap" placeholder="Nama Lengkap" type="text">
...
<br>
    <p class="art-page-footer">
        <span id="art-footnote-links"><a href="http://www.artisteer.com/" target="_blank">Web Template</a> templating web</span>
    </p>
  </div>
</footer>
